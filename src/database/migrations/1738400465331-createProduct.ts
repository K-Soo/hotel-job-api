...
export class CreateProduct1738400465331 implements MigrationInterface {
    name = 'CreateProduct1738400465331'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "applicant" ALTER COLUMN "nickname" SET DEFAULT '9438475982'`);
