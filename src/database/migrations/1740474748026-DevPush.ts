...
export class DevPush1740474748026 implements MigrationInterface {
    name = 'DevPush1740474748026'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "applicant" ALTER COLUMN "nickname" SET DEFAULT '2407018693'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "payment" ALTER COLUMN "payment_type" SET DEFAULT 'RECRUITMENT'`);
