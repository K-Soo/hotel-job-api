...
export class CreateCoupon1739960624827 implements MigrationInterface {
    name = 'CreateCoupon1739960624827'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "coupon" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying NOT NULL, "discount_type" "public"."coupon_discount_type_enum" NOT NULL, "discount_rate" numeric(4,2) NOT NULL DEFAULT '0', "discount_amount" integer NOT NULL DEFAULT '0', "min_order_amount" integer NOT NULL DEFAULT '0', "max_discount_amount" integer NOT NULL DEFAULT '0', "is_single_use" boolean NOT NULL DEFAULT true, "is_public" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP(0) WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "UQ_62d3c5b0ce63a82c48e86d904bc" UNIQUE ("code"), CONSTRAINT "PK_fcbe9d72b60eed35f46dc35a682" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "employer_coupon" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "description" character varying NOT NULL DEFAULT '', "is_expired" boolean NOT NULL DEFAULT false, "is_used" boolean NOT NULL DEFAULT false, "issued_at" TIMESTAMP(6) WITH TIME ZONE NOT NULL, "used_at" TIMESTAMP(6) WITH TIME ZONE, "expires_at" TIMESTAMP(6) WITH TIME ZONE, "created_at" TIMESTAMP(0) WITH TIME ZONE NOT NULL DEFAULT now(), "employer_id" uuid, "coupon_id" uuid, CONSTRAINT "PK_c8422cb0274bbc6c41c284335fe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "payment_recruitment_options" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" "public"."payment_recruitment_options_name_enum" NOT NULL, "duration" "public"."payment_recruitment_options_duration_enum" NOT NULL, "bonus_days" integer NOT NULL DEFAULT '0', "max_list_up_per_day" integer NOT NULL DEFAULT '0', "list_up_interval_hours" integer NOT NULL DEFAULT '0', "tags" "public"."payment_recruitment_options_tags_enum" array NOT NULL DEFAULT '{}', "price" integer NOT NULL DEFAULT '0', "posting_start_date" TIMESTAMP(0) WITH TIME ZONE, "posting_end_date" TIMESTAMP(3) WITH TIME ZONE, "payment_recruitment_id" uuid, CONSTRAINT "PK_9a8283d27a15854a26dd775d3be" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_recruitment" DROP COLUMN "recruit_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_recruitment" ADD "recruitment_id" uuid`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "payment_recruitment" DROP COLUMN "recruitment_id"`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_recruitment" ADD "recruit_id" uuid`);
